...
void my9168_init(SPI_T* f_spi_ch )
{
		...
		SPI_Open(f_spi_ch, (0x0), ((1ul << 2)), 16, 2000000);

    if(f_spi_ch == ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))
		{
    ...
    SPI_DisableInt(f_spi_ch, (0x04) | (0x20));
...
void set_led_data(uint16_t f_data)
{
			...
			((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->TX = (f_data));
